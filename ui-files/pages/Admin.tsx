...
const triageDistribution = [
  { name: "RED", value: 18, color: "oklch(0.62 0.25 25)" },
  { name: "YELLOW", value: 45, color: "oklch(0.85 0.20 95)" },
  { name: "GREEN", value: 79, color: "oklch(0.70 0.18 145)" },
];

const hourlyAdmissions = [
  { hour: "00:00", patients: 8, critical: 2 },
  { hour: "02:00", patients: 5, critical: 1 },
  { hour: "04:00", patients: 3, critical: 0 },
  { hour: "06:00", patients: 12, critical: 3 },
  { hour: "08:00", patients: 18, critical: 4 },
  { hour: "10:00", patients: 22, critical: 5 },
  { hour: "12:00", patients: 25, critical: 6 },
  { hour: "14:00", patients: 20, critical: 4 },
  { hour: "16:00", patients: 24, critical: 5 },
  { hour: "18:00", patients: 19, critical: 3 },
  { hour: "20:00", patients: 15, critical: 2 },
  { hour: "22:00", patients: 11, critical: 2 },
];
          ...
          <div className="flex-1 overflow-y-auto">
            <TabsContent value="dashboard" className="space-y-6 mt-0">
              ...
              <div className="grid grid-cols-4 gap-4">
                <StatCard title="Total Patients" value="142" change="+12%" icon={Users} />
                <StatCard title="Avg Wait Time" value="24m" change="-5%" icon={Activity} />
                <StatCard title="Bed Occupancy" value="88%" change="+2%" icon={Bed} alert />
                <StatCard title="Active Alerts" value="3" change="0" icon={AlertTriangle} color="text-triage-red" />
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                        ...
                        <div key={i} className="flex items-center justify-between border-b border-border/30 pb-2 last:border-0">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">Triage Level: YELLOW • ID: P-10{20+i}</p>
                            </div>
                          </div>
                ...
                <Card className="glass-card">
                  ...
                  <CardContent className="space-y-6">
                    <StatusRow label="Emergency" value={92} status="OVERLOAD" />
                    <StatusRow label="ICU" value={75} status="BUSY" />
                  ...
                  <CardContent className="space-y-8">
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-mono">142/150</span>
                      </div>
                ...
                <Card className="glass-card border-triage-red/30 bg-triage-red/5">
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 rounded-lg border border-triage-red/20 bg-background/50">
                      ...
                      <Button variant="destructive" className="w-full">TRIGGER DIVERT PROTOCOL</Button>
                    </div>
                    <div className="p-4 rounded-lg border border-primary/20 bg-background/50">
                      ...
                      <Button variant="outline" className="w-full">Initiate Recall</Button>
                    </div>
                  </CardContent>
                </Card>
              </div>
