...
export default function DoctorAuth() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-triage-green/5 via-background to-background relative">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-mono">CLINICAL MANAGEMENT</p>
            </div>
          </div>

          <Card className="w-full max-w-lg pb-0 border shadow-md border-triage-green/20">
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                <div className="p-3 bg-muted/50 rounded-lg border border-border">
                  ...
                  <p className="text-xs font-mono">doctor@cityhospital.com / doctor123</p>
                </div>
