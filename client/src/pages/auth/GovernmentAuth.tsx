...
export default function GovernmentAuth() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-triage-yellow/5 via-background to-background relative">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-mono">HEALTH OVERSIGHT</p>
            </div>
          </div>

          <Card className="w-full max-w-lg pb-0 border shadow-md border-triage-yellow/20">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter>
                <Button
                  type="submit"
                  className="w-full bg-triage-yellow hover:bg-triage-yellow/90"
                  disabled={isLoading}
                >
                  {isLoading ? (
